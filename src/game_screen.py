"""This file handles all the text that is appearing in the game, basically UI."""
import sys
...
class GameScreen:
    """
    This class handles several game screen what player can see (game over, intro screen etc.)
    Should be rewritten into menu in the future.
    """
    ...
    def game_over_screen(screen: pygame.Surface):
        """Shows game over screen. Then game ends."""
    ...
    def game_completed_screen(start_time, screen: pygame.Surface):
        """Shows game completed screen. Then game ends."""
        font = pygame.font.Font("./font/OptimusPrinceps.ttf", 72)
